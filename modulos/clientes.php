...
<div class="contenedor">
    <div class="iniciar">
    <h2 class="animate__animated animate__fadeInUp">CLIENTES:</h2>
    </div>
    <div class="columnas">
        <div class="col2">
            <form action="admin.php?action=clientes" method="post">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        if($buscar==NULL OR ""){
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td colspan="1">
                                    <?php
                                        $link = "../shop/admin.php?action=editcliente&id=" . $row['iduser'];
                                        ?>
                        ...
                        ?>
                                    ...
                                    <td colspan="1">
                                    <?php
                                        $link = "../shop/admin.php?action=editcliente" . $row['iduser'];
                                        ?>
                                            <a href="<?php echo $link ?>" class="btn" onlick="">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#495371" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
