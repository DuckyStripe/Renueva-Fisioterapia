...
<h2 class="animate__animated animate__fadeInUp">CLIENTE</h2>
<h2 class="animate__animated animate__fadeInUp">Editar Cliente</h2>
<main class="contenedor centrar">

    <div class="animate__animated animate__zoomIn">
        <div class="columnas">
            <form action="../../php/editclienteinfo.php" method="POST">
                <label for="id">
                ...
                <?php
                $link = "../shop/admin.php?action=editcliente&disabled=1&id=" . $id;
                if ($cambiar == 0) {
                ?>
                    <div class="col1_111">
