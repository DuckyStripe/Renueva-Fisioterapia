...
<body>
    <header class="bg-header">
        <div class="animate__animated animate__bounce" id="menu">
            <ul>
                <li>
                    <a class="info animate__animated  animate__rubberBand navbar-brand logo" href="shop.php">
                    ...
                    <form action="shop.php" method="POST">
                        ...
                        ?>
                            ...
                            <?php } else { ?>
                                <select name="categoria" id="categoria" onchange="this.form.submit()">
                                    <?php
                                    $query2 = "SELECT * FROM categoria WHERE id_categoria=$categoria;";
                                    $consulta2 = mysqli_query($connect, $query2);
                                    $select = mysqli_fetch_array($consulta2);
                                    ?>
                                    <option selected value="<?php echo $select['id_categoria'] ?>"><?php echo $select['nombre_cat'] ?></option>
                ...
                <li>
                    <form action="shop.php" method="GET">
                        <input class="animate__animated animate__zoomIn" type="search" name="buscar" id="buscar" placeholder="Producto" required>
                ...
                <li class="info item-r animate__animated  animate__rubberBand">
                    <a class="navbar-brand logo" href="../shop/shop.php?action=carrito">
